/**
 * Email Finder v4.0 - Merge Results from Multiple Instances
 * Combines email-results-1.json, email-results-2.json, etc.
 */
...
function mergeResults() {
    console.log('🔄 Merging Email Finder Results');
    ...
    const files = fs.readdirSync(DATA_DIR)
        .filter(f => f.startsWith('email-results-') && f.endsWith('.json'));
    ...
    console.log(`\n✅ Merged: ${allResults.length} total leads`);
