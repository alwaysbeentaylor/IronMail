        ...
        try {
            while (!signal.aborted) {
                ...
                try {
                    ...
                    // ---- STEP 3: DNS_CHECK ----
                    await logActivity('DNS_CHECK', 'checking', `Domein DNS controleren...`);
                    ...
                    // Improved French/German/Dutch Detection
                    ...
                    else if (loc.includes('france') || loc.includes('paris') || emD.endsWith('.fr') || nm.includes('hervé') || nm.includes('françois')) lang = 'French';
                ...
                // TURBO DELAY: If we skipped, don't wait 10 seconds.
                const delayS = isTurboSkip ? 1 : (settings?.delaySeconds || 10);
